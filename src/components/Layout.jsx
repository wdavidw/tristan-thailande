...
import garuda from '@/images/garuda.svg'
...
function Glow() {
  let id = useId()
  return (
    <div className="absolute inset-0 -z-10 overflow-hidden bg-[#252029] lg:right-[calc(max(2rem,50%-38rem)+40rem)] lg:min-w-[32rem]">
      <svg
...
function FixedSidebar({ main, footer }) {
  return (
    <div className={clsx(
      "relative flex-none overflow-hidden px-6 lg:pointer-events-none lg:fixed lg:inset-0 lg:z-40 lg:flex lg:px-0",
    )}>
      <Glow />
      <Image {...garuda} className="absolute max-w-none w-[160%] md:w-[120%] lg:w-[70%] top-[-80px] md:top-[-120px] lg:top-[-60px] left-[-120px] lg:left-[-30px] opacity-20" />
